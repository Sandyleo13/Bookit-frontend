...
export default function Checkout() {
  ...
  useEffect(() => {
    setBookingId("BOOK" + Math.floor(100000 + Math.random() * 900000));
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate(`/result?success=true&id=${res.data.bookingId || bookingId}`, {
        state: {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-8 py-10 grid md:grid-cols-2 gap-10 bg-gray-50">
      {/* Left Section - User Details */}
      <div>
        <form
          onSubmit={handleSubmit}
          className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md space-y-5"
        >
          ...
          <input
            ...
            required
            className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400"
            value={form.name}
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400"
              value={form.promo}
      ...
      <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200 h-fit sticky top-28">
